...
const _slideLima = function () {
  ...
  slideLima.addEventListener('animationend', () => {
    ...
    trims.classList.add('animate__animated', 'animate__fadeOut', 'animate__delay-s');
    setTimeout(() => {
      trims.remove();
      setTimeout(() => {
        slideLima.remove();
...
new TypeIt("#teks1", {
  strings: ["Туған күнің құтты болсын, Дилназик!.", "Саған шаттық пен бақыт тілеймін. Армандарың орындалып, өмірің гүлге толсын! 🌷✨", "Өмірің әрдайым шуақты болсын, асыл армандарың бір-бірлеп орындалсын", "армандаған оқу орныңа жол ашылсын.🌟📚" , "Қанатың талмасын, арманың орындалсын! 💙🎓"],
  startDelay: 4000,
  speed: 80,
...
new TypeIt("#teks2", {
  strings: ["Білім жолың ашық болсын, грантқа түсіп, ата-анаңның үмітін ақтай бер!", " ", "Бар жақсылық өзіңмен бірге болсын! ✨🎓.", " ", "Айловю Дилназик:)"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
